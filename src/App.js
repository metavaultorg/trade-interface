...
import ClaimEsMvx from "./views/ClaimEsMvx/ClaimEsMvx";
...
import logoSmallImg from "./img/mvx.png";
    ...
    if (!hasCoinBaseWalletExtension()) {
      helperToast.error(
        <div>
          ...
          <br />
          <br />
          <a href="https://www.coinbase.com/wallet" target="_blank" className="ahreftextcolorwallet" rel="noopener noreferrer">
      ...
      <div className="App">
        ...
        <div className="App-content">
          ...
          <header>
            <div className="App-header large">
              <div className="App-header-container-left">
                <Link className="App-header-link-main" to="/">
                  <img src={logoImg} className="big" alt="MVX Logo" />MVX
                  <img src={logoSmallImg} className="small" alt="MVX Logo" />
                </Link>
                <AppHeaderLinks />
              </div>
              ...
              >
                <div className="App-header-container-left">
                  ...
                  <div className="App-header-link-main clickable" onClick={() => setIsDrawerVisible(!isDrawerVisible)}>
                    <img src={logoImg} className="big" alt="MVX Logo" />
                    <img src={logoSmallImg} className="small" alt="MVX Logo" />
                  </div>
                </div>
                <div className="App-header-container-right">
          ...
          <Switch>
            ...
            <Route exact path="/claim_es_mvx">
              <ClaimEsMvx setPendingTxns={setPendingTxns} />
            </Route>
