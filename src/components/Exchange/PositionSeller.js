...
export default function PositionSeller(props) {
  ...
  if (position) {
    ...
    maxAmountFormatted = formatAmount(maxAmount, USD_DECIMALS, USD_DISPLAY_DECIMALS, true);
    maxAmountFormattedFree = formatAmountFree(maxAmount, USD_DECIMALS, USD_DISPLAY_DECIMALS);
      ...
      if (orderOption === MARKET) {
        return (
          <div className="Confirmation-box-warning">
            ...
            <a
              href="https://docs.metavault.trade/trading"
              target="_blank"
  ...
  function renderExecutionFee() {
    ...
    return (
      <ExchangeInfoRow label="Execution Fees">
        {formatAmount(DECREASE_ORDER_EXECUTION_GAS_FEE, 18, 2)} {nativeTokenSymbol}
      </ExchangeInfoRow>
    );
  }
        ...
        <Modal isVisible={isVisible} setIsVisible={setIsVisible} label={title}>
            ...
            <div className="Exchange-swap-section">
              <div className="Exchange-swap-section-top">
                ...
                <div
                  ...
                  onClick={() => {
                    setTriggerPriceValue(formatAmountFree(position.markPrice, USD_DECIMALS, position.indexToken.displayDecimals));
                  }}
                >
          ...
          <div className="PositionEditor-info-box">
            ...
            <div className="Exchange-info-row top-line">
              ...
              <div className="align-right">${formatAmount(fundingFee, USD_DECIMALS, USD_DISPLAY_DECIMALS, true)}</div>
            </div>
            <div className="Exchange-info-row">
              <div className="Exchange-info-label">Closing Fee</div>
              <div className="align-right">
                {positionFee && `$${formatAmount(positionFee, USD_DECIMALS, USD_DISPLAY_DECIMALS, true)}`}
                {!positionFee && "-"}
              </div>
            </div>
            <div className="Exchange-info-row">
