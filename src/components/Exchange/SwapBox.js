  ...
  const renderAvailableLongLiquidity = () => {
    ...
    return (
      <div className="Exchange-info-row">
        ...
        <div className="align-right">{formatAmount(toTokenAvailableUsd, USD_DECIMALS, USD_DISPLAY_DECIMALS, true)}</div>
      </div>
    );
  };
          ...
          <React.Fragment>
            <div className="Exchange-swap-section">
              <div className="Exchange-swap-section-top">
                <div className="muted">
                  {fromUsdMin && (
                    <div className="Exchange-swap-usd">Pay: {formatAmount(fromUsdMin, USD_DECIMALS, USD_DISPLAY_DECIMALS, true)} USD</div>
                  )}
                  {!fromUsdMin && "Pay"}
                </div>
                {fromBalance && (
          ...
          <div className="Exchange-leverage-box">
            ...
            <div className="Exchange-info-row">
              ...
              <div className="align-right">
                {hasExistingPosition && toAmount && toAmount.gt(0) && (
                  <div className="inline-block muted">
                    ${formatAmount(existingPosition.averagePrice, USD_DECIMALS, existingPosition.indexToken.displayDecimals, true)}
                    <BsArrowRight className="transition-arrow" />
                  </div>
                )}
            ...
            <div className="Exchange-info-row">
              ...
              <div className="align-right">
                {hasExistingPosition && toAmount && toAmount.gt(0) && (
                  <div className="inline-block muted">
                    ${formatAmount(existingLiquidationPrice, USD_DECIMALS, existingPosition.indexToken.displayDecimals, true)}
                    <BsArrowRight className="transition-arrow" />
                  </div>
                )}
                {toAmount &&
                    ...
                    renderContent={() => {
                      return (
                        <>
                          ...
                          <div>
                            Position Fee (0.1% of position size): ${formatAmount(positionFee, USD_DECIMALS, USD_DISPLAY_DECIMALS, true)}
                          </div>
                        </>
                      );
                    }}
      ...
      {isSwap && (
        <div className="Exchange-swap-market-box App-box App-box-border">
          ...
          <div className="Exchange-info-row">
            ...
            <div className="align-right">
              {fromTokenInfo && formatAmount(fromTokenInfo.minPrice, USD_DECIMALS, fromTokenInfo.displayDecimals, true)} USD
            </div>
          </div>
          <div className="Exchange-info-row">
            ...
            <div className="align-right">
              <Tooltip
                ...
                renderContent={() => {
                  return (
                    <>
                      The position will be opened at {formatAmount(entryMarkPrice, USD_DECIMALS, markPriceDisplayDecimals, true)} USD with a
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer" className="ahreftextcolorwallet"
                      >
                        More Info
                      </a>
                    </>
