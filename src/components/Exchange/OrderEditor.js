    ...
    if (hasProfit && delta.eq(0)) {
      ...
      return (
        <div className="Confirmation-box-warning">
          ...
          of {deltaStr}. <br />
          Profit price: {position.isLong ? ">" : "<"} ${formatAmount(profitPrice, USD_DECIMALS, position.indexToken.displayDecimals, true)}. This rule
      ...
      >
        ...
        <div className="Exchange-swap-section">
          <div className="Exchange-swap-section-top">
            ...
            <div
              ...
              onClick={() => {
                setTriggerPriceValue(formatAmountFree(indexTokenMarkPrice, USD_DECIMALS, order.indexToken.displayDecimals));
              }}
            >
          ...
          {triggerPrice && !triggerPrice.eq(order.triggerPrice) ? (
            <>
              <span className="muted">
                {triggerPricePrefix} {formatAmount(order.triggerPrice, USD_DECIMALS, order.indexToken.displayDecimals, true)}
              </span>
              &nbsp;
              <BsArrowRight />
              &nbsp;
        ...
        {liquidationPrice && (
          <div className="Exchange-info-row">
            ...
            <div className="align-right">{`$${formatAmount(liquidationPrice, USD_DECIMALS, order.indexToken.displayDecimals, true)}`}</div>
          </div>
        )}
    ...
    >
      ...
      {fromTokenInfo && (
        <div className="Exchange-info-row">
          ...
          <div className="align-right">{formatAmount(fromTokenInfo.minPrice, USD_DECIMALS, fromTokenInfo.displayDecimals, true)} USD</div>
        </div>
      )}
      {toTokenInfo && (
        <div className="Exchange-info-row">
          <div className="Exchange-info-label">{toTokenInfo.symbol} price</div>
          <div className="align-right">{formatAmount(toTokenInfo.maxPrice, USD_DECIMALS, toTokenInfo.displayDecimals, true)} USD</div>
        </div>
      )}
      <div className="Exchange-swap-button-container">
        <button
